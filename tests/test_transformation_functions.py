...
class TestSnapshotTransformationFunctions:
    ...
    def setup_method(self):
        ...
        with (
            patch("eavt_helper.classes.snapshot.os.path.exists", return_value=True),
    ...
    def test_with_drop_snapshot_columns_missing_columns(self):
        ...
        test_df = pd.DataFrame({"user_id": [1, 2], "name": ["John", "Jane"]})
        ...
        test_df = pd.DataFrame(
            {
                ...
                "v": [25, 25, 26, 30, 31],
                "t": pd.to_datetime(
                    ["2023-01-01", "2023-01-02", "2023-01-03", "2023-01-01", "2023-01-02"]
                ),
            }
        )
    ...
    def test_with_stack_reset_index(self):
        ...
        test_df = pd.DataFrame(
            ...
            index=pd.MultiIndex.from_tuples(
                [(1, "2023-01-01"), (2, "2023-01-01")], names=["user_id", "timestamp"]
            ),
        )
...
class TestEAVTTransformationFunctions:
    ...
    def setup_method(self):
        ...
        with (
            patch("eavt_helper.classes.eavt.os.path.exists", return_value=True),
    ...
    def test_with_current_row_indicator(self):
        ...
        for entity in result["e"].unique():
            ...
            current_rows = entity_rows[entity_rows["current_row_indicator"]]
